...
class _CutterPageState extends State<CutterPage> {
  ...
  Future<void> _download() async {
    ...
    try {
      final video = await _yt.videos.get(_url.text.trim());
      ...
      final command = '-y -ss ${_ffTime(start)} -i ${_quote(videos.first.url.toString())} '
          '-ss ${_ffTime(start)} -i ${_quote(audios.first.url.toString())} '
